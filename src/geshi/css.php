...
$language_data = array (
    ...
    'KEYWORDS' => array(
        ...
        1 => array(
            ...
            'empty-cells',
            'fill','fill-rule','fill-opacity', /* svg */
            ...
            'stroke','stroke-width','stroke-linecap','stroke-linejoin','stroke-miterlimit','stroke-dasharray','stroke-dashoffset', /* svg */
        ...
        2 => array(
            ...
            'avoid','background','backwards','baseline','below',
            'bevel', /* svg */
            'bidi-override',
            ...
            'min-intrinsic',
            'miter', /* svg */
            'mix','monospace','move','multiple','n-resize',
            'narrower','ne-resize','no-close','no-close-quote','no-open-quote',
            'no-repeat','none',
            'nonzero', /* svg */
            'normal','nowrap','nw-resize','oblique','once',
