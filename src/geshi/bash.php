...
$language_data = array (
    ...
    'KEYWORDS' => array(
        ...
        2 => array(
            ...
            'git-rebase--interactive', 'git-receive-pack', 'git-receive-pack',
            'git-reflog', 'gitregrep', 'git-relink', 'git-remote', 'git-repack',
            'git-repo-config', 'git-request-pull', 'git-rerere', 'git-reset',
            'git-revert', 'git-rev-list', 'git-rev-parse', 'gitrfgrep',
            'gitrgrep', 'git-rm', 'git-send-pack', 'git-shell', 'git-shell',
            'git-shortlog', 'git-show', 'git-show-branch', 'git-show-index',
            'git-show-ref', 'git-sh-setup', 'git-stage', 'git-stash',
            'git-status', 'git-stripspace', 'git-submodule', 'git-svn',
            'git-symbolic-ref', 'git-tag', 'git-tar-tree', 'gitunpack',
            'git-unpack-file', 'git-unpack-objects', 'git-update-index',
            'git-update-ref', 'git-update-server-info', 'git-upload-archive',
            'git-upload-archive', 'git-upload-pack', 'git-upload-pack',
