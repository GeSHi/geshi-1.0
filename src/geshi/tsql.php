    ...
    'KEYWORDS' => array(
        1 => array(
            ...
            */
            ...
            'DATEFROMPARTS','DATETIMEFROMPARTS', 'SMALLDATETIMEFROMPARTS', 'DATETIME2FROMPARTS', 'DATEFROMPARTS', 'TIMEFROMPARTS',
            ...
            'STATS_DATE','@@TRANCOUNT','USER_NAME', '@@IDENTITY', '@@LANGUAGE',
        ...
        2 => array(
            ...
            'FROM', 'FUNCTION', 'GENERAL', 'GET', 'GLOBAL', 'GO', 'GOTO', 'GRANT', 'GROUP', 'GROUPING', 'HADR', 'HAVING', 'HOLDLOCK', 'HOST',
            ...
            'OPTIMIZER_WHATIF',
            'ORDER', 'ORDINALITY', 'OUT', 'OUTPUT', 'OVER', 'OWNER', 'PAD', 'PARAMETER', 'PARAMETERS',  'PARTIAL', 'PARTITION', 'PASSWORD', 'PATH', 'PERCENT', 'PLAN',
            ...
            'SETS', 'SETUSER', 'SHOW_STATISTICS', 'SHOWWEIGHTS', 'SHUTDOWN', 'SIZE', 'SMALLINT', 'SNAPSHOT', 'SPACE', 'SPECIFIC', 'SPECIFICATION',
        ...
        4 => array(
            ...
            'column_type_usages', 'column_xml_schema_collection_usages', 'columns', 'computed_columns', 'configurations',
            ...
            'parameters', 'partition_functions', 'partition_parameters', 'partition_range_values', 'partition_schemes',
            ...
            'sequences', 'server_assembly_modules', 'server_audit_specification_details', 'server_audit_specifications',
            ...
            'system_parameters', 'system_sql_modules', 'system_views', 'table_types', 'tables', 'tcp_endpoints', 'trace_categories',
            ...
            'views', 'xml_indexes', 'xml_schema_attributes', 'xml_schema_collections', 'xml_schema_component_placements',
