 ...
 * Copyright: (c) 2018 Andrew Janke (https://apjanke.net)
 * Release Version:
 * Date Started: 2018/12/15
 *
 * CSH language file for GeSHi. Includes TCSH enhancements.
 *
 * Based on the bash language file by Andreas Gohr and Nigel McNie.
 *
 * CHANGES
 * -------
 * ()
...
$language_data = array (
    'LANG_NAME' => 'CSH',
    // CSH DOES have single line comments with # markers. But bash also has
    // the  $# and $#name variables, so comments need special handling
    ...
    'KEYWORDS' => array(
        1 => array(
            'break', 'breaksw', 'case', 'continue', 'default:', 'elif', 'else', 'end',
            'endif', 'endsw', 'foreach', 'function', 'goto', 'if', 'in',
            'select', 'set', 'switch', 'then', 'time', 'while'
            ),
        2 => array(
        ...
        3 => array(
            ...
            'echo', 'enable', 'eval', 'exec', 'exit', 'fc',
            'fg', 'getopts', 'hashstat', 'help', 'history', 'jobs', 'let',
            'local', 'logout', 'noglob', 'onintr', 'popd', 'printf', 'pushd', 'readonly', 'rehash',
            'return', 'setenv', 'shift', 'shopt', 'source', 'suspend', 'test', 'times',
            'trap', 'type', 'typeset', 'limit', 'umask', 'unalias', 'unhash', 'unset',
            'wait', 'which', 'where'
            )
        ),
    'SYMBOLS' => array(
