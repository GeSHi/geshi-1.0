...
$language_data = array(
    ...
    'KEYWORDS' => array(
        ...
        2 => array(
            ...
            '&lt;F4&gt;', '&lt;F5&gt;', '&lt;F6&gt;', '&lt;F7&gt;',
            '&lt;F8&gt;', '&lt;F9&gt;', '&lt;cr&gt;', '&lt;silent&gt;',
            '-nargs', 'acd', 'ai', 'ai', 'akm', 'al', 'aleph',
            'allowrevins', 'altkeymap', 'ambiwidth', 'ambw',
            'ambw', 'anti', 'antialias', 'ar', 'arab', 'arabic',
            'arabicshape', 'ari', 'ari', 'arshape', 'autochdir',
            'autoindent', 'autoread', 'autowrite', 'autowriteall',
            'aw', 'aw', 'awa', 'background', 'backspace', 'backup',
            'backupcopy', 'backupdir', 'backupext', 'backupext',
            'backupskip', 'balloondelay', 'ballooneval', 'balloonexpr',
            'bdir', 'bdlay', 'beval', 'beval', 'bex', 'bexpr', 'bg',
            'bh', 'bin', 'binary', 'biosk', 'biosk', 'bioskey',
            'bk', 'bkc', 'bl', 'bomb', 'breakat', 'brk', 'brk',
            'browsedir', 'bs', 'bsdir', 'bsk', 'bt', 'bufhidden',
            'buflisted', 'buflisted', 'buftype', 'casemap', 'cb',
            'ccv', 'cd', 'cdpath', 'cedit', 'cedit', 'cf', 'cfu', 'ch',
            'charconvert', 'ci', 'cin', 'cindent', 'cindent', 'cink',
            'cinkeys', 'cino', 'cinoptions', 'cinw', 'cinwords',
            'clipboard', 'clipboard', 'cmdheight', 'cmdwinheight',
            'cmp', 'cms', 'co', 'columns', 'com', 'com', 'com',
            ...
            'confirm', 'confirm', 'consk', 'conskey', 'copyindent',
            'cot', 'cp', 'cpo', 'cpoptions', 'cpoptions', 'cpt',
            'cscopepathcomp', 'cscopeprg', 'cscopequickfix', 'cscopetag',
            'cscopetagorder', 'cscopeverbose', 'cscopeverbose',
            'cspc', 'csprg', 'csqf', 'cst', 'csto', 'csverb', 'cuc',
            'cuc', 'cul', 'cursorcolumn', 'cursorline', 'cwh', 'debug',
            'deco', 'def', 'def', 'define', 'delc', 'delco', 'delcom',
            'delcombine', 'delcomm', 'delcomman', 'delcommand', 'dex',
            'dg', 'dict', 'dictionary', 'diff', 'diff', 'diffexpr',
            'diffopt', 'digraph', 'dip', 'dir', 'directory', 'display',
            'display', 'dlcomma', 'dy', 'ea', 'ead', 'eadirection',
            'eb', 'ed', 'edcompatible', 'edcompatible', 'ef', 'efm',
            'ei', 'ek', 'enc', 'encoding', 'endofline', 'endofline',
            'eol', 'ep', 'equalalways', 'equalprg', 'errorbells',
            'errorfile', 'errorformat', 'errorformat', 'esckeys', 'et',
            'eventignore', 'ex', 'expandtab', 'exrc', 'fcl', 'fcl',
            'fcs', 'fdc', 'fde', 'fdi', 'fdl', 'fdls', 'fdm', 'fdm',
            'fdn', 'fdo', 'fdt', 'fen', 'fenc', 'fencs', 'fex', 'fex',
            'ff', 'ffs', 'fileencoding', 'fileencodings', 'fileformat',
            'fileformats', 'filetype', 'filetype', 'fillchars', 'fk',
            'fkmap', 'flp', 'fml', 'fmr', 'fo', 'fo', 'foldclose',
            'foldcolumn', 'foldenable', 'foldexpr', 'foldignore',
            'foldlevel', 'foldlevelstart', 'foldlevelstart', 'foldmarker',
            'foldmethod', 'foldminlines', 'foldnestmax', 'foldopen',
            'foldtext', 'formatexpr', 'formatexpr', 'formatlistpat',
            'formatoptions', 'formatprg', 'fp', 'fs', 'fsync', 'ft',
            'ft', 'gcr', 'gd', 'gdefault', 'gfm', 'gfn', 'gfs', 'gfw',
            'gfw', 'ghr', 'go', 'gp', 'grepformat', 'grepprg', 'gtl',
            'gtt', 'gtt', 'guicursor', 'guifont', 'guifontset',
            'guifontwide', 'guiheadroom', 'guioptions', 'guipty',
            'guipty', 'guitablabel', 'guitabtooltip', 'helpfile',
            'helpheight', 'helplang', 'hf', 'hh', 'hh', 'hid', 'hidden',
            'history', 'hk', 'hkmap', 'hkmap', 'hkmapp', 'hkp', 'hl',
            'hlg', 'hls', 'hlsearch', 'ic', 'ic', 'icon', 'iconstring',
            'ignorecase', 'im', 'imactivatekey', 'imak', 'imc', 'imc',
            'imcmdline', 'imd', 'imdisable', 'imi', 'iminsert', 'ims',
            'imsearch', 'imsearch', 'inc', 'include', 'includeexpr',
            'incsearch', 'inde', 'indentexpr', 'indentkeys', 'indentkeys',
            'indk', 'inex', 'inf', 'infercase', 'insertmode', 'is', 'isf',
            'isf', 'isfname', 'isi', 'isident', 'isk', 'iskeyword',
            'isp', 'isprint', 'isprint', 'joinspaces', 'js', 'key',
            'keymap', 'keymodel', 'keywordprg', 'km', 'km', 'kmp', 'kp',
            'langmap', 'langmenu', 'laststatus', 'lazyredraw', 'lbr',
            'lbr', 'lcs', 'linebreak', 'lines', 'linespace', 'lisp',
            'lispwords', 'list', 'list', 'listchars', 'lm', 'lmap',
            'loadplugins', 'lpl', 'ls', 'lsp', 'lsp', 'lw', 'lz', 'ma',
            'macatsui', 'magic', 'makeef', 'makeprg', 'makeprg', 'mat',
            'matchpairs', 'matchtime', 'maxcombine', 'maxfuncdepth',
            'maxmapdepth', 'maxmem', 'maxmem', 'maxmempattern',
            'maxmemtot', 'mco', 'mef', 'menuitems', 'mfd', 'mh', 'mh',
            'mis', 'mkspellmem', 'ml', 'mls', 'mm', 'mmd', 'mmp',
            'mmp', 'mmt', 'mod', 'modeline', 'modelines', 'modifiable',
            'modified', 'more', 'more', 'mouse', 'mousef', 'mousefocus',
            'mousehide', 'mousem', 'mousemodel', 'mouses', 'mouses',
            'mouseshape', 'mouset', 'mousetime', 'mp', 'mps', 'msm',
            'mzq', 'mzq', 'mzquantum', 'nf', 'noacd', 'noai', 'noakm',
            ...
            'numberwidth', 'nuw', 'nuw', 'odev', 'oft', 'ofu',
            'omnifunc', 'opendevice', 'operatorfunc', 'opfunc',
            'opfunc', 'osfiletype', 'pa', 'para', 'paragraphs',
            'paste', 'pastetoggle', 'patchexpr', 'patchexpr',
            'patchmode', 'path', 'pdev', 'penc', 'pex', 'pexpr',
            'pfn', 'pfn', 'ph', 'pheader', 'pi', 'pm', 'pmbcs',
            'pmbfn', 'popt', 'popt', 'preserveindent', 'previewheight',
            'previewwindow', 'printdevice', 'printencoding', 'printexpr',
            'printfont', 'printfont', 'printheader', 'printmbcharset',
            'printmbfont', 'printoptions', 'prompt', 'pt', 'pumheight',
            'pumheight', 'pvh', 'pvw', 'qe', 'quoteescape', 'rdt',
            'readonly', 'redrawtime', 'redrawtime', 'remap', 'report',
            'restorescreen', 'revins', 'ri', 'rightleft', 'rightleftcmd',
            'rightleftcmd', 'rl', 'rlc', 'ro', 'rs', 'rtp', 'ru', 'ru',
            'ruf', 'ruler', 'rulerformat', 'runtimepath', 'sb', 'sbo',
            'sbo', 'sbr', 'sc', 'scb', 'scr', 'scroll', 'scrollbind',
            'scrollbind', 'scrolljump', 'scrolloff', 'scrollopt',
            'scs', 'sect', 'sections', 'sections', 'secure', 'sel',
            'selection', 'selectmode', 'sessionoptions', 'sft',
            'sft', 'sh', 'shcf', 'shell', 'shellcmdflag', 'shellpipe',
            'shellquote', 'shellquote', 'shellredir', 'shellslash',
            'shelltemp', 'shelltype', 'shellxquote', 'shiftround',
            'shiftround', 'shiftwidth', 'shm', 'shortmess', 'shortname',
            'showbreak', 'showcmd', 'showcmd', 'showfulltag', 'showmatch',
            'showmode', 'showtabline', 'shq', 'si', 'si', 'sidescroll',
            'sidescrolloff', 'siso', 'sj', 'slm', 'sm', 'sm', 'smartcase',
            'smartindent', 'smarttab', 'smc', 'smd', 'sn', 'sn',
            'so', 'softtabstop', 'sol', 'sp', 'spc', 'spell', 'spell',
            'spellcapcheck', 'spellfile', 'spelllang', 'spellsuggest',
            'spf', 'spl', 'spl', 'splitbelow', 'splitright', 'spr',
            'sps', 'sr', 'srr', 'srr', 'ss', 'ssl', 'ssop', 'st', 'sta',
            'stal', 'stal', 'startofline', 'statusline', 'stl', 'stmp',
            'sts', 'su', 'su', 'sua', 'suffixes', 'suffixesadd', 'sw',
            'swapfile', 'swapsync', 'swapsync', 'swb', 'swf', 'switchbuf',
            'sws', 'sxq', 'syn', 'syn', 'synmaxcol', 'syntax', 'ta',
            'tabline', 'tabpagemax', 'tabstop', 'tabstop', 'tag',
            'tagbsearch', 'taglength', 'tagrelative', 'tags', 'tagstack',
            'tagstack', 'tal', 'tb', 'tbi', 'tbidi', 'tbis', 'tbs',
            'tbs', 'tenc', 'term', 'termbidi', 'termencoding', 'terse',
            'textauto', 'textauto', 'textmode', 'textwidth', 'tf', 'tgst',
            'thesaurus', 'tildeop', 'tildeop', 'timeout', 'timeoutlen',
            'title', 'titlelen', 'titleold', 'titlestring', 'titlestring',
            'tl', 'tm', 'to', 'toolbar', 'toolbariconsize', 'top', 'top',
            'tpm', 'tr', 'ts', 'tsl', 'tsr', 'ttimeout', 'ttimeout',
            'ttimeoutlen', 'ttm', 'tty', 'ttybuiltin', 'ttyfast', 'ttym',
            'ttym', 'ttymouse', 'ttyscroll', 'ttytype', 'tw', 'tx', 'uc',
            'uc', 'ul', 'undolevels', 'updatecount', 'updatetime', 'ut',
            'vb', 'vb', 'vbs', 'vdir', 've', 'verbose', 'verbosefile',
            'vfile', 'vfile', 'vi', 'viewdir', 'viewoptions', 'viminfo',
            'virtualedit', 'visualbell', 'visualbell', 'vop', 'wa', 'wak',
            'warn', 'wb', 'wc', 'wc', 'wcm', 'wd', 'weirdinvert', 'wfh',
            'wfw', 'wh', 'wh', 'whichwrap', 'wi', 'wig', 'wildchar',
            'wildcharm', 'wildignore', 'wildignore', 'wildmenu',
            'wildmode', 'wildoptions', 'wim', 'winaltkeys', 'window',
            'window', 'winfixheight', 'winfixwidth', 'winheight',
            'winminheight', 'winminwidth', 'winwidth', 'winwidth', 'wiv',
            'wiw', 'wm', 'wmh', 'wmnu', 'wmw', 'wmw', 'wop', 'wrap',
            'wrapmargin', 'wrapscan', 'write', 'writeany', 'writeany',
        ...
        3 => array(
            ...
            'FileReadPost', 'FileReadPre', 'FileType', 'FileType',
